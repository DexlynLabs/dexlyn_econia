...
module econia::incentives {
    ...
    struct IncentiveParameters has drop, key {
        ...
        /// `supra_framework::coin::Coin<address:module::MyCoin>`) of
    ...
    /// utility coins from an `supra_framework::Coin::CoinStore`.
    ///
    ...
    /// utility coins from an `supra_framework::Coin::CoinStore` and
        ...
        IncentiveParameters
    {
        ...
        set_incentive_parameters<SupraCoin>(econia,
            MARKET_REGISTRATION_FEE, UNDERWRITER_REGISTRATION_FEE,
            CUSTODIAN_REGISTRATION_FEE, TAKER_FEE_DIVISOR,
    ...
    /// `supra_framework::coin::CoinStore`.
    ///
    /// # Testing
    ///
    /// * `test_withdraw_to_coin_store_econia()`
        ...
        IncentiveParameters
    {
        ...
        // Assert state.
        verify_utility_coin_type<SupraCoin>();
        ...
        assert!(exists<UtilityCoinStore<SupraCoin>>(
