...
module econia::market {
    ...
    ///
    /// Initializes an `supra_framework::coin::CoinStore` for each coin
    ...
    /// coins from an `supra_framework::coin::CoinStore`.
    ///
    /// # Testing
    ///
    /// * `test_register_markets()`
    ...
    ///   user's `supra_framework::coin::CoinStore` or from standalone
    ...
    #[test_only]
    /// After initializing an Supra account (2 handles) and two order
    /// books (2 handles per).
    const FIRST_EVENT_HANDLE_RESOURCE_ACCOUNT: u64 = 6;
    #[test_only]
    /// After initializing an Supra account (2 handles), four market
