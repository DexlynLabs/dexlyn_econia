...
module econia::registry {
    ...
    struct MarketInfo has copy, drop, store {
        ...
        /// `supra_framework::coin::Coin`, corresponds to the phantom
        /// `CoinType` (`address:module::MyCoin` rather than
        /// `supra_framework::coin::Coin<address:module::MyCoin>`).
        ...
        /// a coin, corresponds to `supra_framework::coin::Coin.value`).
        lot_size: u64,
        /// Number of quote coin units exchanged per tick (corresponds
        /// to `supra_framework::coin::Coin.value`).
        tick_size: u64,
