...
module econia::assets {
    ...
    ///
    /// Similarly initializes the Supra coin, destroying capabilities.
    public fun init_coin_types_test() {
        ...
        // Initialize Supra coin type, storing capabilities.
        let (burn_cap, mint_cap) = supra_coin::initialize_for_test(
            &account::create_signer_with_capability(
                &account::create_test_signer_cap(@supra_framework)));
        // Destroy Supra coin burn capability.
        coin::destroy_burn_cap(burn_cap);
        // Destroy Supra coin mint capability.
